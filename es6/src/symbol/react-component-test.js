...
function PureComponent(props, context, updater) {
  /**
   * Duplicated from Component. 从Component复制
   */
  this.props = props;
  this.context = context;
  this.refs = emptyObject;
...
// console.log(new Component(1, 2, 3));
// console.log(new PureComponent(1, 2, 3));
// console.log(new AsyncComponent(1, 2, 3));
